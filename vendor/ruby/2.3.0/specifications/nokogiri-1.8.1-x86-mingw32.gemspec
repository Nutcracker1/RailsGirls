# -*- encoding: utf-8 -*-
# stub: nokogiri 1.8.1 x86-mingw32 lib
...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "Nokogiri is built with the packaged libraries: libxml2-2.9.5, libxslt-1.1.30, zlib-1.2.11, libiconv-1.15.\n".freeze
